...
# the dinner, so you need to send out a new set of
# invitations. You will have to think of someone
# else to invite.
...
declined_invitations = f"Mr. {idol_guest_list[0].title()}, " \
                       ...
                       f"dinner table will not arrive in time for " \
                       f"\nthe dinner, and I will not be able to " \
                       f"accommodate all six of your for " \
                       f"dinner."
...
# to that person letting them know you can't invite
# them to dinner.
...
print(f"Mr. {idol_guest_declined1.title()}, I am sorry to "
      f"inform you but the dinner table will not "
      f"\narrive in time for dinner, and I will no be able "
      f"to accommodate you for dinner.")
...
print(f"Mr. {idol_guest_declined2.title()}, I am sorry "
      f"to inform you but the dinner table will not "
      f"\narrive in time for dinner, and I will no be able "
      f"to accommodate you for dinner.")
...
print(f"Mr. {idol_guest_declined3.title()}, I am sorry to "
      f"inform you but the dinner table will not "
      f"\narrive in time for dinner, and I will no be able "
      f"to accommodate you for dinner.")
...
print(f"Mr. {idol_guest_declined4.title()}, I am sorry to "
      f"inform you but the dinner table will not "
      f"\narrive in time for dinner, and I will no be able "
      f"to accommodate you for dinner.")
...
extinguished_guests = f"Mr. {idol_guest_list[0].title()} " \
                      ...
                      f"are still invited to the dinner."
